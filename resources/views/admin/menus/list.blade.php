...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Menus
            <small>manage front end menus</small>
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <a href="{{url('admin/menus/create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Create new</a>
                        </div>
                    </div>
