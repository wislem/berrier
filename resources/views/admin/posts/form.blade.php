@if($post)
    {!! BootForm::open()->action('/admin/posts/' . $post->id)->put() !!}
    {!! BootForm::bind($post) !!}
@else
    {!! BootForm::open()->action('/admin/posts') !!}
@endif
<div class="box-body">

    {!! BootForm::checkbox('Published', 'is_active')->defaultToChecked() !!}
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3 class="text-info">Media management <small>add images and reorder them by drag 'n drop (first image will be the featured image)</small></h3>
            <div id="mediazone" class="dropzone">
...
<div class="preview-template" style="display: none;">
    <div class="thumbnail dz-preview dz-image-preview">
        <div class="dz-image">
