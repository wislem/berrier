...
@section('content')
    ...
    <section class="content-header">
        <h1>
            User Settings
            <small>manage user settings</small>
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">List of user settings</h3>
                        <div class="box-tools">
                            <a href="{{url('admin/usettings/create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Create new</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover table-striped" id="grid-data">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-column-id="default">Default value</th>
                                        <th data-column-id="user_editable" data-formatter="user_editable">User editable</th>
