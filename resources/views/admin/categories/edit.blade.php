<div class="row">
    <div class="col-md-12">
        {!! BootForm::open()->action('/admin/categories/' . $category->id)->attribute('id', 'modal-form')->put() !!}
        {!! BootForm::bind($category) !!}
        {!! BootForm::hidden('action')->value('rename') !!}
        ...
        {!! BootForm::open()->action('/admin/categories/' . $category->id)->delete() !!}
        {!! BootForm::submit('Delete', 'btn btn-danger') !!}
        {!! BootForm::close() !!}
    </div>
</div>
